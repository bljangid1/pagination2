...
<body>
        ...
        <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<nav aria-label="Page navigation example">
                      <ul class="pagination">
                      <li class="page-item">
      <a class="page-link" href="display.php?page=' . ($page - 1) . '" aria-label="Previous">
    ...
    <li class="page-item"><a class="page-link" href="display.php?page=' . $i . '">' . $i . '</a></li>
                ';
                }

                echo '
                 <li class="page-item">
      <a class="page-link" href="display.php?page=' . ($page + 1) . '" aria-label="Next">
